...
export const experience: Experience[] = [
  {
    ...
    stack: ["mongodb", "express", "angular", "react", "nodejs"],
    bullets: [
      "Completed an intensive 5-month Full Stack Web Development track (MEARN), focusing on real-world projects and teamwork.",
    ...
    keyAchievements: [
      ...
      "Delivered MVP (Naafe) 2 weeks ahead of schedule.",
    ],
  },
  {
    ...
    bullets: [
      "Evaluated the helpfulness of search results on Google and YouTube.",
