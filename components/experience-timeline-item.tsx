              ...
              <AccordionTrigger className="p-6 hover:no-underline">
                <div className="text-left w-full">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-2">
                    ...
                    <div className="text-sm 3xl:text-base text-muted-foreground text-center sm:text-right flex-shrink-0">
                  ...
                  {experience.location && (
                    <div className="flex items-center gap-1 text-sm 3xl:text-base text-muted-foreground justify-center sm:justify-start">
