  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl">{project.title} - Case Study</DialogTitle>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">{caseStudyDetails.problem}</p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">{caseStudyDetails.solution}</p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">{caseStudyDetails.architecture}</p>
          </div>
