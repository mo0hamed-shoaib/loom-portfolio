    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-xl text-secondary-foreground">{project.summary}</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="font-mono-technical typography-p text-foreground">{caseStudyDetails.problem}</p>
          </div>
          ...
          <div>
            ...
            <p className="font-mono-technical typography-p text-foreground">{caseStudyDetails.solution}</p>
          </div>
          ...
          <div>
            ...
            <p className="font-mono-technical typography-p text-foreground">{caseStudyDetails.architecture}</p>
          </div>
